class Card < ApplicationRecord
    ...
    DATE = %r(^(1[0-2]|0[1-9])/(3[01]|[12][0-9]|0[1-9])/[0-9]{4}$)
    validates :expiration_date, presence: true, length: {minimum: 10, maximum: 10}, 
    format: {with: DATE, multiline: true, message: "should be DD/MM/YYYY"}
